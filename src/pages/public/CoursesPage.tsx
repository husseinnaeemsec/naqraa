              ...
              >
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    name="search"
                    type="text"
                    className="w-full p-3 pr-12 border bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 shadow-sm"
                  />
                </div>
                <motion.button
                  type="submit"
                ...
                <Link to={'/courses/explore'}
                  className="border-emerald-600 hover:border-emerald-700 border px-6 py-3 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 min-w-[120px]"
                >
                  تصفح الدورات
                </Link>
              </motion.form>
