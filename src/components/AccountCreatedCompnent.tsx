...
export default function AccountCreated( { message } : { message:string } ){
    ...
    return (
        <div className="flex items-center justify-center h-dvh w-dvw bg-white">
            <div className="max-w-xl w-full mx-auto space-y-3 p-4">
                <img src={verifiedImg} className='w-40 mx-auto' alt="" />
                <h1 className="text-2xl font-bold text-center"> جميع بياناتك صحيحة  </h1>
